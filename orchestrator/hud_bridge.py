...
class HudBridge:
    ...
    def _serve_page(self, connection, request) -> Response | None:
        ...
        - **The path is different on every machine** — `C:/Users/user/oddball/hud/...` on
          Windows, `/home/user/oddball/hud/...` on the Pi. Over HTTP there is one URL.
    ...
    def set_state(self, name: str) -> None:
        """Set his state on the rig. One writer, one surface.

        There was briefly a second surface — a floating ball in a pywebview window — and this
        method mirrored into it. That was a mistake: the rig BELOW already renders the
        character, and the ball was a duplicate of him sitting in the corner of his own
        desktop. It is gone, and `thinking` and `speaking` now animate the real face. D17.
        """
