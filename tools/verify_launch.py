...
LIVE = {"XDG_RUNTIME_DIR": "/run/user/1000", "WAYLAND_DISPLAY": "wayland-0",
        "HOME": "/home/user", "DBUS_SESSION_BUS_ADDRESS": "unix:path=/run/user/1000/bus"}
DARK = {"XDG_RUNTIME_DIR": str(Path(_tmp.name) / "empty-runtime"), "HOME": "/home/user"}
...
def s5_display() -> None:
    ...
    with tempfile.TemporaryDirectory() as tmp:
        ...
        d = launcher.find_display({"XDG_RUNTIME_DIR": tmp, "HOME": "/home/user"})
    ...
    d = launcher.find_display({"XDG_RUNTIME_DIR": "/nonexistent/xyz", "HOME": "/home/user"})
...
def probe() -> int:
    ...
    launcher.find_display = lambda environ=None: launcher.Display(
        runtime_dir="/run/user/1000", wayland="wayland-0", home="/home/user",
        seen=("wayland-0",))
